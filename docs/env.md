...
- Активный trial покрывает все включённые XUI-хосты так же, как paid global. Если первичная выдача была частичной, недостающие хосты довыдаёт `/sub/<token>` и scheduler.
